<template>
  <section>
    <div class="tabsContainer">
      ...
      <div class="tabItemDots hover" @click="isCatalogPanelOpen=!isCatalogPanelOpen" v-if="cList.length && (!isPublic || isRedactor)">
        ...
      </div>
    </div>
      ...
      >
        <div class="fc" v-if="cTabItem">
          <div>
            ...
            <button @click="moveLeft(cTabItem,cList)" class="myBtn cb px-3 mr20">left</button>
            <button @click="moveRight(cTabItem,cList)" class="myBtn cb px-3 mr20">right</button>
            <input
              type="text"
          ...
          <button @click="isCatalogPanelOpen=false" class="cr">x</button>
        </div>
        <!--        <div class="mt20" v-if="mainStore.user.isA">-->
        <!--          <button @click="$store.dispatch('fetchInfoK')" class="mr10">fetchInfoK</button>-->
        <!--          <button @click="setTabToK">set tab to K</button>-->
        <!--          <button @click="$store.dispatch('updateFBInfoKDiagrams')">update K</button>-->
        <!--        </div>-->
      </div>
    </div>
...
<!--  //   if(this.list){-->
<!--  //     return this.list-->
<!--  //   }else return this.mainStore?.currentInfo?.diagramsList||[]-->
<!--  // })-->
